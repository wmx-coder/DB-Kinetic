...
class CVDatasets():
    def __init__(self, fpath, batch_size=32):
        ...
        data_df = pd.read_pickle(fpath)[["new_ezy_feat", "sbt_feat", "log10_Km", "fold"]].copy()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Km Training (With Deepcopy)",
                                     formatter_class=RawDescriptionHelpFormatter)
    parser.add_argument("-data_fpath", type=str,
                        default="/mnt/usb3/code/wm/data/km_data/km_with_complete_feats.pkl",
                        help="Dataset path")
    ...
    parser.add_argument("-log_dir", type=str, default="logfile_model2_1", help="Log directory")
    parser.add_argument("-results_dir", type=str, default="results_model2_1", help="Results directory")
    ...
    final_pred_df.to_csv("final_pred_label_model2_1.csv")
    ...
    final_metrics.to_csv("final_results_model2_1.csv", index=False)
