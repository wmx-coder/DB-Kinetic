...
# 导入修改后的Kcat模型
from model_rdkitfp import Model_Regression, ActivityModel_Freeze as ActivityModel
...
class CVDatasets():
    def __init__(self, fpath, batch_size=32):
        ...
        data_df = pd.read_pickle(fpath)[["new_ezy_feat", "rdkitfp_feat", "log10_kcat", "fold"]].copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-data_fpath", type=str,
                        default="/mnt/usb3/code/wm/data/kcat_data/kcat-data_feats_complete_with_rdkitfp.pkl",
    ...
    parser.add_argument("-km_model_dir", type=str,
                        ...
                        help="Km预训练模型目录")
    # 输出路径
    parser.add_argument("-log_dir", type=str, default="logfile_model_rdkitfp_1", help="日志目录")
    parser.add_argument("-results_dir", type=str, default="results_model_rdkitfp_1", help="结果目录")
    parser.add_argument("-model_save_dir", type=str,
                        default="/mnt/usb/code/wm/catapro/yuxunlian_models/kcat/kcat/model_rdkitfp_1",
                        help="模型保存目录")
    # 超参数
