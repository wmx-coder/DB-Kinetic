...
class CVDatasets():
    def __init__(self, fpath, batch_size=32):
        ...
        data_df = pd.read_pickle(fpath)[["new_ezy_feat", "rdkitfp_feat", "log10_kcat_over_Km", "fold"]].copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-data_fpath", type=str,
                        default="/mnt/usb3/code/wm/data/kcat_km/kcat_km_v1_with_rdkitfp.pkl",
                        help="Dataset path")
    ...
    parser.add_argument("-model_save_dir", type=str,
                        default="/mnt/usb/code/wm/catapro/yuxunlian_models/kcat/kcat_km/model_rdkitfp_1",
