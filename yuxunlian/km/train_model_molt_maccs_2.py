...
class Mydatasets(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        esm_pt_path = os.path.join(self.esm_feat_dir, f"unique_km_{esm_id}.pt")
...
class CVDatasets():
    def __init__(self, fpath, esm_feat_dir, batch_size=32):
        ...
        self.esm_feat_dir = esm_feat_dir  # ESM .pt文件目录
        # 读取带esm_id的数据集（需提前生成）
        data_df = pd.read_pickle(fpath)[["esm_id", "sbt_feat", "log10_Km", "fold"]].copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-data_fpath", type=str,
                        default="/mnt/usb3/code/wm/data/km_data/km_with_complete_feats_with_esm_id.pkl",
                        help="带ESM ID的数据集路径")
    parser.add_argument("-esm_feat_dir", type=str,
                        default="/mnt/usb3/code/wm/esm/km/",
                        help="ESM .pt文件存储目录")
