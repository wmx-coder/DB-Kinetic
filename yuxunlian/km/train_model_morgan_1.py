...
from model_morgan import Model_Regression  # 注：如果是单独文件，需确保导入路径正确，这里已内置模型定义
...
class CVDatasets():
    def __init__(self, fpath, batch_size=32):
        ...
        data_df = pd.read_pickle(fpath)[["new_ezy_feat", "morgan_feat", "log10_Km", "fold"]].copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-data_fpath", type=str,
                        default="/mnt/usb3/code/wm/data/km_data/km_with_complete_feats_with_morgan.pkl",
                        help="Dataset path")
    ...
    parser.add_argument("-log_dir", type=str, default="logfile_model_morgan_1", help="Log directory")
    parser.add_argument("-results_dir", type=str, default="results_model_morgan_1", help="Results directory")
    ...
    final_metrics.to_csv(os.path.join(args.results_dir, "final_results_model_morgan_1.csv"), index=False,
                         float_format="%.4f")
