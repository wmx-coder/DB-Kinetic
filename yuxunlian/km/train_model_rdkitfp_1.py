...
from model_rdkitfp import Model_Regression  # 注：如果是单独文件，需确保导入路径正确，这里已内置模型定义
...
class CVDatasets():
    def __init__(self, fpath, batch_size=32):
        ...
        data_df = pd.read_pickle(fpath)[["new_ezy_feat", "rdkitfp_feat", "log10_Km", "fold"]].copy()
        ...
        self.sbt_feats = np.array([
            f for f in data_df["rdkitfp_feat"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-data_fpath", type=str,
                        default="/mnt/usb3/code/wm/data/km_data/km_with_complete_feats_with_rdkitfp.pkl",
                        help="Dataset path")
    ...
    parser.add_argument("-model_save_dir", type=str,
                        default="/mnt/usb/code/wm/catapro/yuxunlian_models/kcat/km/model_rdkitfp_1",
                        help="Directory to save best models")
    parser.add_argument("-log_dir", type=str, default="logfile_model_rdkitfp_1", help="Log directory")
    parser.add_argument("-results_dir", type=str, default="results_model_rdkitfp_1", help="Results directory")
    ...
    final_metrics.to_csv(os.path.join(args.results_dir, "final_results_model_rdkitfp_1.csv"), index=False,
                         float_format="%.4f")
