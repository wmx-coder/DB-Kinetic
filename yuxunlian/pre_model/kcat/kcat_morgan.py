...
# -------------------------- 核心配置（按需修改） --------------------------
INPUT_PATH = "/mnt/usb3/code/wm/data/kcat_data/kcat-data_feats_complete.pkl"  # 输入CSV/Pickle
OUTPUT_PATH = "/mnt/usb3/code/wm/data/kcat_data/kcat-data_feats_complete_with_morgan.pkl"  # 输出Pickle
