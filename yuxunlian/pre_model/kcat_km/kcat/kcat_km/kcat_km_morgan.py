...
# -------------------------- 核心配置（按需修改） --------------------------
INPUT_PATH = "/mnt/usb3/code/wm/data/kcat_km/kcat_km_v1_with_fold.pkl"  # 输入CSV/Pickle
OUTPUT_PATH = "/mnt/usb3/code/wm/data/kcat_km/kcat_km_v1_with_morgan.pkl"  # 输出Pickle
