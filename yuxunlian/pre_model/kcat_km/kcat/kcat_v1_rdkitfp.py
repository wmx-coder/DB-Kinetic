...
# -------------------------- 配置参数 --------------------------
input_pkl_path = "/mnt/usb3/code/wm/data/kcat_data/kcat-data_feats_complete.pkl"
output_pkl_path = "/mnt/usb3/code/wm/data/kcat_data/kcat-data_feats_complete_with_rdkitfp.pkl"
